...
const Home = () => {
    ...
    const get_data = async () => {
        const response = await axios.post(`${BASE_URL}/get_user_issue`, {
                                ...
                                <div key={index} className='p-3 w-[90%]  bg-white text-vlt border border-gray-200 shadow-md shadow-gray-200'>
                                    <div className="flex justify-between">
                                        ...
                                        <div className='flex gap-2 '>
                                            <div className='flex hover:bg-gray-300 flex-col gap-1 items-center px-4 py-1 rounded-full border border-gray-200'>
                                    ...
                                    <Tag value={element.selectedDepartment.name}></Tag>
                                    <Divider />
                                    <Inplace>
                                        <InplaceDisplay className='bg-gray-200 p-2 rounded-md'>{element.issue_description.substring(0, 50) + ' read more...'}</InplaceDisplay>
                                        <InplaceContent>
